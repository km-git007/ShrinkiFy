   ...
   theme: {
      extend: {
         backgroundImage: {
            ...
            "custom-gradient-3": "linear-gradient(to left, #0061ff, #f43f5e)",
            "custom-gradient-4": "linear-gradient(to right, #0061ff, #f43f5e)",
            "card-gradient": "linear-gradient(to right, #38b2ac, #4299e1)",
            // "card-gradient": "linear-gradient(to right, #0061ff, #f43f5e)",
         },
         colors: {
            navbarColor: "#ffffff",
            btnColor: "#3364F7",
